...
%prep
%setup -q -n sphinx_notfound_page-1.1.0
cd %{_builddir}/sphinx_notfound_page-1.1.0
pushd ..
cp -a sphinx_notfound_page-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738101196
